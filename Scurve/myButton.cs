...
namespace SpinnyFlashyShinyControls
{
    ...
    public class myButton : Button
    {
        ...
        private void DrawGlass(Graphics gr, Rectangle rectBar)
        {
            ...
            {
                case State.Click:
                    ColorBacklight = GetDarkerColor(Color.White, 10);
                    ColorFillBK = GetDarkerColor(this.ClickColor, 30);
                    ColorBorder = GetDarkerColor(this.ClickColor, 60);
                    break;
                case State.Hover:
                    ColorBacklight = GetLighterColor(Color.White, 5);
                    ColorFillBK = GetLighterColor(this.HoverColor, 10);
                    ColorBorder = GetDarkerColor(this.HoverColor, 100);
                    break;
                case State.Normal:
                default:
                    ColorBacklight = this.BackColor;
                    ColorFillBK = GetDarkerColor(this.BackColor, 70);
